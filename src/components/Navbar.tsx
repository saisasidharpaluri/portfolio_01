            ...
            {navLinks.map((link) => {
              ...
              return (
                <li key={link.href}>
                  <Link 
                    href={link.href} 
                    className={`block py-2 px-3 rounded md:p-0 transition-all duration-200
                      ${isActive 
                        ? 'text-white bg-blue-700 md:bg-transparent md:text-blue-700 md:dark:text-blue-500 font-bold' 
